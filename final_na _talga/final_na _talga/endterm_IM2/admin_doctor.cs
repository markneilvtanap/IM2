    ...
    public partial class admin_doctor : Form
    {
        ...
        private void Doc_add_Click(object sender, EventArgs e)
        {
...

            {
                ...
                string sqlAdding = "INSERT INTO `doctor` (`DoctorID`, `FirstName`, `LastName`, `Age`, `Sex`, `DateOfBirth`, `Address`, `ContactNumber`, `Email`,`Licence_number`, `Position`, `Specialization`, `Experience`, `Username`, `Password`) VALUES (NULL, '" + this.Doc_Fname.Text + "', '" + this.Doc_LName.Text + "', '" + this.Doc_age.Text + "', '" + this.sex + "', '" + this.dateTimePicker1.Text + "', '" + this.Doc_address.Text + "', '" + this.Doc_contact_no.Text + "', '" + this.Doc_email.Text + "',, '" + this.textBox1.Text + "', '" + this.Doc_email.Text + "', '" + this.Doc_position.Text + "', '" + this.Doc_specialization.Text + "', '" + this.Doc_experience.Text + "', '" + this.Doc_username.Text + "', '" + this.doc_pass.Text + "');";
