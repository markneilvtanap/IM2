...
namespace endterm_IM2
{
    public partial class Doc_patient_student_ques : UserControl
    {
        ...
        {
            InitializeComponent();
            medHistory = this.txtbox_med_history;
            medicationsx = this.txtbox_medications;
            suplimenets = this.txtbox_allergies;
            famhis1 = this.txtbox_family_hist1;
            famhis2 = this.txtbox_family_hist2;
            chronicCon = this.txtbox_chronic;



        }

        private void Doc_patient_student_ques_Load(object sender, EventArgs e)
        {
